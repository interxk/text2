...
class sptosp(QtWidgets.QMainWindow):
    def __init__(self):
        super(sptosp,self).__init__()
        self.setupUi(self)
    ...
    def setupUi(self, MainWindow):
        ...
        self.pushButton.clicked.connect(self.sp2sp)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label.setText(_translate("MainWindow", "<html><head/><body><p><span style=\" font-size:26pt;\">视频转换</span></p></body></html>"))
